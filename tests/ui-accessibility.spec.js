...
test.describe('UI & Accessibility', () => {
  ...
  test('game view has proper heading hierarchy', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { level: 1, name: 'Netflix Architecture Challenge' })).toBeVisible();
  ...
  test('loading states and transitions work smoothly', async ({ page }) => {
    ...
    await expect(page.getByRole('heading', { name: 'Netflix Architecture Challenge' })).toBeVisible();
